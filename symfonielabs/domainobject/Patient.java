...
public class Patient implements Serializable{
	...
	/**
	 * Holds the Patient Type (extended gender).
	 */
	private String patientType;
	/**
	 * Holds the Source Order Type.
	 */
	...
	/**
	 * Holds the external MRN of the patient.
	 */
	...
	public Patient(final String fullName, final String gender,
			final String physicianName, final Date dateOfBirth,
			...
			final String modality, final String patientHLABId,
			final String externalMRN, final String labName,
			...
			final String sortField, final long listSize, final Date lastDrawDate, final String patientType) {
		super();
	...
	public Patient(final String fullName, final String gender,
			...
			final String HLABNumber, final long startIndex,
			final long endIndex, final String sortDirection,
			final String sortField, final long listSize, final Date lastDrawDate, final String orderType,final String patientType) {
		super();
		this.fullName = fullName;
		this.gender = gender;
		this.physicianName = physicianName;
	...
	public String toString() {
		return "fullName: " + fullName + "~|~" + "gender: " + gender + "~|~"
				...
				+ patientHLABId + "~|~" + "externalMRN: " + externalMRN + "~|~"
