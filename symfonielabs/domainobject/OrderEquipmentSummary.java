 ...
 * 
 */
public class OrderEquipmentSummary implements Serializable {
	...
	// ih_dw.dim_lab_order_details.SPECIMEN_METHOD_DESC  timc added to Order Summary for: Source
	private String specimenMethodDesc;
		
	public String getSpecimenMethodDesc() {
		return specimenMethodDesc;
	}
	public void setSpecimenMethodDesc(String specimenMethodDesc) {
	...
	public OrderEquipmentSummary(long orderId, Date drawDate, String requisitionNum,
			...
			final boolean abnormalFlag, final boolean cancelledTestIndicator, String specimenMethodDesc) {
		super();
	...
	public String toString() {
		return "orderId: " + orderId + "~|~" + "drawDate: " + drawDate + "~|~"
				...
				+ "listSize: " + listSize + "~|~" + "entityIndex: "	+ entityIndex + "~|~" 
				+ "abnormalFlag: "+abnormalFlag + "~|~"
				+ "cancelledTestIndicator: " +cancelledTestIndicator+ "~|~"
				+ "specimenMethodDesc: " +specimenMethodDesc + "~|~"
				+ "facility: " + facility 
				+ "~|~"
