...
public class SsoWClass  {
	String app;	
	Attributes attrs = null;
            
	public Attributes get_attributes(String username,Properties prop)
    {		
        final String ATTRIBUTE_FOR_USER = prop.getProperty("ATTRIBUTE_FOR_USER_WEST");
        final String _domain  = prop.getProperty("_domain_west");
        final String host 	  = prop.getProperty("host_west");
        final String dn		  = prop.getProperty("dn_west");
              ...
              String returnedAtts[] ={"telephonenumber" };
                  ...
                  System.out.println(" PROVIDER_URL_WEST "+prop.getProperty("PROVIDER_URL_WEST"));
                  environment.put(Context.INITIAL_CONTEXT_FACTORY, prop.getProperty("INITIAL_CONTEXT_FACTORY"));
                  environment.put(Context.PROVIDER_URL, prop.getProperty("PROVIDER_URL_WEST"));
                  environment.put(Context.SECURITY_AUTHENTICATION, prop.getProperty("SECURITY_AUTHENTICATION"));
                  environment.put(Context.SECURITY_PRINCIPAL, prop.getProperty("SECURITY_PRINCIPAL_WEST"));
                  environment.put(Context.SECURITY_CREDENTIALS,prop.getProperty("SECURITY_CREDENTIALS_WEST"));
