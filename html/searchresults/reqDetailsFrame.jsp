                          ...
                          <div class="wid40 pull-left">
                            <div class="mar-box">
								<div class="pull-left wid40 ">
									<%if ("PATIENT".equalsIgnoreCase(patientTypeSubGrp) || "STUDY".equalsIgnoreCase(patientTypeSubGrp)) {%>
										<p>Patient Name
                                        <% if (patientType.equalsIgnoreCase("AC")) { %>
                                        	<img src="<%=request.getContextPath()%>/images/acute.png" title="Acute Patient" alt="acute" class="space" width='17' height='17' />	
                                        	</p>
                                        <% } %>
									  <%} else if ("STAFF".equalsIgnoreCase(patientTypeSubGrp)) {%>
										<p>Staff Name
								...
								<div class="pull-left wid50">
									<label><a onclick="goToOrderSummaryPage();"><strong style="font-size: 14px;">&nbsp;<%=patientName %></strong></a></label>
								</div>
